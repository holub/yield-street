...
import yieldstreet.test.packet.Packet;
import yieldstreet.test.packet.PacketValidator;
...
public class PacketValidatorReverseEngineeringTest extends TestCase {
    ...
    @Test
    public void testChecksumReverseEngineering() throws Exception {
        assertEquals(Integer.toHexString(packet.checksum),
                Integer.toHexString(PacketValidator.calcChecksumReverseEngineering(packet)));
    }
}